		...
		var callbacks = {
            ...
            success : function(data) {
                ...
                if(selectedNode.nodeName != 'A') { // New link.
        		    ed.execCommand('mceInsertContent', false, '<a id="' + content_association.target_model_link_id + '" href="' + content_association.target_model_link + '" rel="contentassociation">' + tinyMCEPopup.editor.selection.getContent() + '</a>');
        		} else { // Editing a link.
