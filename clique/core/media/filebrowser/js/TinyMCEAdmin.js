...
tinyMCE.init({
    ...
    theme_advanced_buttons1: "formatselect,bold,italic,underline,bullist,numlist,|,justifyleft,justifycenter,justifyright,justifyfull,|,outdent,indent,|,undo,redo,anchor,link,unlink,hr,template,image,code,removeformat,cut,copy,paste,pastetext,pasteword,media,charmap,contentassociationlink,contentassociationunlink,|,tablecontrols",
