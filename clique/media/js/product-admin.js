$(document).ready(function() {
    ...
    tinyMCE.init({
    	mode : "exact",
    	elements : "id_long_description,id_product_details",
    	theme : "advanced",
    	...
    	theme_advanced_buttons4 : "insertlayer,moveforward,movebackward,absolute,|,styleprops,|,cite,abbr,acronym,del,ins,attribs,|,visualchars,nonbreaking,template,pagebreak,contentassociation",
