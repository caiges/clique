...
class BasePage(models.Model):
    ...
    page_title = models.CharField(max_length = 100, blank = False, null = False, help_text = "Page Title")
    url = models.CharField(max_length = 1000, blank = False, null = False, help_text = "URL will be appended to base URL of the content type being edited.")
